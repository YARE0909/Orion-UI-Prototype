...
export default function Toast({ t, content, type }:
  ...
  if (type === "success") {
    return (
      <div
        className={`bg-background border-2 border-green-500 rounded-md ${t.visible ? 'animate-enter' : 'animate-leave'
          }`}
      >
  ...
  if (type === "error") {
    return (
      <div
        className={`bg-background border-2 border-red-500 rounded-md ${t.visible ? 'animate-enter' : 'animate-leave'
          }`}
      >
  ...
  if (type === "warning") {
    return (
      <div
        className={`bg-background border-2 border-yellow-500 rounded-md ${t.visible ? 'animate-enter' : 'animate-leave'
          }`}
      >
  ...
  if (type === "info") {
    return (
      <div
        className={`bg-background border-2 border-indigo-500 rounded-md ${t.visible ? 'animate-enter' : 'animate-leave'
          }`}
      >
